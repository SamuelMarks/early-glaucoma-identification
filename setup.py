...
if __name__ == '__main__':
    package_name = 'early_glaucoma_identification'
    ...
    s1_data_join, s1_data_install_dir = to_funcs('S1_data')
    ...
    setup(
        ...
        data_files=[
            ...
            (s1_data_install_dir(), list(imap(s1_data_join, listdir(s1_data_join())))),
        ]
    )
